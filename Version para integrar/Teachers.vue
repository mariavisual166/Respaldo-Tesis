   ...
   <div  class="row" id="submenu">
      <div class="col">
        <div class="nav nav-item nav-pills text-center fondo"   role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="LinkArchivo" href="#" role="tab" aria-controls="v-pills-home" aria-selected="true">CARGA DE ARCHIVO</a>
          <a class="nav-link" id="LinkFecha" data-toggle="pill" href="#" role="tab" aria-controls="v-pills-profile" aria-selected="false">FECHAS TOPES</a>
        </div>
      </div>
    </div
  <h3></h3>
